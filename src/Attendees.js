...
class Attendees extends Component {
  ...
  chooseRandom() {
    this.resetQuery();
    if(this.state.allAttendees.length) {
  ...
  render() {
    ...
    console.log('len: ', this.state.displayAttendees.length);
    if(this.state.displayAttendees.length) {
      filteredAttendees = this.state.displayAttendees.filter(dataFilter);
    } 
